...
/* accessing object properties
	...
	*/ 
	 scarletWitch = {name: 'Wanda Maximoff', age: 29, powers: 1};
	 
	 console.log(scarletWitch.name);
	 console.log(scarletWitch['name']);
...
/*
	var anchors = document.getElementByTageName('a');
	console.log(anchors);
...
/*
 //individual ID selected
	var nav = document.querySelectorAll('#nav');
	console.log(nav);

//this will show the li' for the nav search. this makes the array from the li's and not the full nav
	var nav = document.querySelectorAll('#nav li');
	console.log(nav);

//can also do things like filters
